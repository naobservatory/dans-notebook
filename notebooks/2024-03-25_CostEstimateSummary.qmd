...
3. [NAO Cost Estimate MVP](./2024-02-02_CostEstimateMVP.html)
4. [NAO Cost Estimate -- Optimizing the sampling interval](./2024-02-08_OptimalSamplingInterval.html)
5. [NAO Cost Estimate -- Adding noise](./2024-02-22_StochasticMVP.html)
...
[NAO Cost Estimate MVP](./2024-02-02_CostEstimateMVP.html)
for details.
...
See
[NAO Cost Estimate -- Adding noise](./2024-02-22_StochasticMVP.html)
...
The first two terms on the right-hand side are equivalent to the result from the [P2RA model](Simple detection cost for P2RA) using the conversion between prevalence and incidence implied by our exponential growth model.
...
In the [Appendix](./2024-02-22_StochasticMVP.html#appendix-small-pool-noise) to the noise post,
